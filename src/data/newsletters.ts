...
`,
  ...
  },
  {
    ...
    tag: 'AI & Hiring',
    excerpt:
      'A year ago I called it the Trust Paradox and suggested we build some transparency before things got weird. Things got weird: 291 applications per hire, one in eight candidates fake on a single req, eleven nations issuing a joint deepfake advisory, and a judge ruling that your vendor is your agent.',
    body: `
<img src="/newsletters/edition-86/drowning-in-applications.webp" alt="A recruiter in a suit surfacing from a desk buried under dozens of printed pages headed JOB APPLICATION" />

<p>Last year the story was awkward. Hiring managers squinting at shortlists they didn’t understand. Candidates hanging up on cheerful robots. Everyone using the tech, nobody vouching for it. I called it <a href="https://www.linkedin.com/pulse/trust-paradox-high-volume-hiring-mike-wood-qtoce/">the Trust Paradox</a> and suggested we build some transparency before things got weird.</p>

<p>Things got weird.</p>

<p>In the twelve months since, three things happened that I genuinely did not have on the bingo card.</p>

<ul>
  <li>The volume problem actually got worse 🫨</li>
  <li>A third party joined the conversation who isn’t a person at all.</li>
  <li>The lawyers showed up, which is how you know something has started to become a liability.</li>
</ul>

<p>Let’s take them in order.</p>

<h3>Part One: The math broke</h3>

<p>Here’s the number that should end every “our AI saves recruiters time” pitch you sit through this fall.</p>

<p>According to <a href="https://www.ashbyhq.com/talent-trends-report/reports/recruiting-operations-benchmarks-talent-trends">Ashby’s latest data</a>, recruiters now process roughly 291 applications per hire. In early 2021, it was about 100. Nearly triple the intake for the same single outcome.</p>

<p>And what did all that automation buy us? <a href="https://finance.yahoo.com/small-business/articles/job-application-got-faster-job-210440313.html">Time-to-fill is up almost 25% versus pre-pandemic</a>, per Indeed. We tripled the throughput and slowed down the outcome. If a vendor sold you a machine that did that to your warehouse, you’d have their CEO on the phone by lunch.</p>

<p>The mechanism is not mysterious. Recruiters all know the basic logic that they don’t have time to see every resume. They “see” maybe 25 of 750 applicants, screen a handful, and call them “the best.” What’s changed is that the 750 is now 2,000 and a meaningful slice of it was generated by someone’s agent while they slept. Cost-to-apply has collapsed to roughly zero and when applying is free, volume is not a signal of interest. It’s just more slop. *Note, I am not advocating charging applicants, but an application should not carry the same weight and effort as a spam email.</p>

<p>We built faster filters, so candidates built faster firehoses.</p>

<h3>Part Two: The trust numbers, one year later</h3>

<p>Last year I quoted <a href="https://www.hbs.edu/ris/Publication%20Files/hiddenworkers09032021_Fuller_white_paper_33a2047f-41dd-47b1-9a8d-bd08cf3bfa94.pdf">the Harvard Business School finding</a> that 88% of employers believed their own systems were screening out qualified people. I assumed that would embarrass someone into fixing it.</p>

<p>It did not. According to <a href="https://www.greenhouse.com/newsroom/63-of-job-seekers-have-faced-an-ai-interview-most-havent-had-a-good-one-yet">Greenhouse</a>, only 21% of recruiters now say they’re “very confident” their systems aren’t weeding out qualified candidates. Four out of five recruiters are running a machine they will not personally vouch for.</p>

<p>On the candidate side, the collapse is steeper and better documented:</p>

<ul>
  <li>63% of US job seekers have now been interviewed by an AI — up 13 points in six months (Greenhouse)</li>
  <li>38% have walked away from a hiring process because it included an AI interview, with another 12% saying they would</li>
  <li>46% say their faith in the hiring process has decreased</li>
  <li>26% — just 26% — trust AI to evaluate them fairly (Gartner)</li>
</ul>

<p>Harvard career advisor Gorick Ng <a href="https://finance.yahoo.com/small-business/articles/job-application-got-faster-job-210440313.html">put it to Axios better than I could</a>: we’ve moved past ordinary job search burnout into systemic cynicism. Candidates now assume every posting is fake and every rejection is automated.</p>

<p>Here’s the uncomfortable part: they’re not wrong to assume it. <a href="https://www.greenhouse.com/blog/greenhouse-2024-state-of-job-hunting-report">Greenhouse’s internal data</a> pegs ghost jobs at 18–22% of posted roles in a typical quarter. Roughly one in five postings isn’t a real opening. We have spent two years telling candidates their distrust is a perception problem. It’s a data problem, and the data is ours.</p>

<h3>Part Three: The double standard didn’t soften. It hardened.</h3>

<p>My favorite bit of hypocrisy from last year’s piece has aged into policy.</p>

<p>87% of organizations use AI in hiring. 82% of hiring managers worry about candidates using AI — specifically that it obscures who someone really is (<a href="https://www.forbes.com/sites/williamarruda/2026/07/16/the-ai-hiring-paradox-employers-use-ai-but-dont-trust-candidates-who-do/">Resume Genius, via Forbes, July 2026</a>).</p>

<p>Read those two numbers next to each other and you see the contradiction. We deploy language models to score sentiment and rank humans, then clutch our pearls when an applicant uses ChatGPT to fix their bullet points.</p>

<p>But I want to be more careful than I was last year, because there’s a real distinction buried in the outrage, and it isn’t the one recruiters usually make. Using AI to prepare, translate, or articulate is not cheating, it’s the same category as a résumé coach or a friend who’s good at editing. Using a live copilot to feed you answers during an evaluation is a different thing, and most employers treat it as grounds for rescinding an offer. The problem is that we’ve collapsed both into “inauthentic,” and in doing so we’ve penalized preparation while barely detecting deception.</p>

<p>Which brings us to the guest who wasn’t invited.</p>

<h3>Part Four: The third party at the table isn’t a person</h3>

<p>This is the genuinely new chapter, and it’s the reason “just add more AI screening” stopped being a viable answer.</p>

<ul>
  <li>The DOJ has alleged that <a href="https://www.cbsnews.com/news/north-korea-duping-us-companies-tech-worker-scheme-doj/">300+ US companies unknowingly hired workers tied to North Korea</a>. One Arizona woman ran a “laptop farm” out of her house that placed operatives at over 300 companies and generated more than $17 million.</li>
  <li>Amazon <a href="https://www.bbc.com/news/articles/c3e0kw80wwzo">blocked more than 1,800 suspected North Korean applicants</a>, with attempts rising 27% quarter over quarter.</li>
  <li><a href="https://fortune.com/2025/04/11/job-applicants-deepfake-ai-imposters-how-to-bust-imposters-hiring-managers-hr-leaders/">Pindrop</a> — a fraud detection company, so grade accordingly — found roughly 1 in 8 applicants fake on a single developer req.</li>
  <li><a href="https://www.prnewswire.com/news-releases/new-getreal-security-research-41-of-enterprises-surveyed-report-having-hired-and-onboarded-fraudulent-candidates-302638982.html">41% of organizations surveyed</a> say they have already onboarded a fraudulent candidate. Not caught. Onboarded.</li>
  <li>Palo Alto Networks <a href="https://unit42.paloaltonetworks.com/north-korean-synthetic-identity-creation/">found it takes as little as 70 minutes</a>, with zero image-editing experience, to build a fake candidate who can pass a live video interview.</li>
  <li>Gartner projects that <a href="https://www.gartner.com/en/newsroom/press-releases/2025-07-31-gartner-survey-shows-just-26-percent-of-job-applicants-trust-ai-will-fairly-evaluate-them">by 2028, one in four candidate profiles globally will be fake</a>.</li>
</ul>

<p>In August, <a href="https://www.techtimes.com/articles/322688/20260802/north-korean-it-workers-use-real-time-deepfakes-beat-hiring-checks-eleven-nations-warn.htm">eleven nations issued a joint advisory</a> on real-time deepfakes defeating live hiring screens. Eleven nations. About job interviews.</p>

<p>Sit with what that does to the trust paradox. Last year the question was whether the algorithm was judging humans fairly. Now the prior question is whether there’s a human there at all. Every verification step you add to answer that makes the process colder and slower for the 99% of applicants who are exactly who they say they are — which drives more of them to walk, which further concentrates your pipeline among people who are highly motivated to be in it. Some of whom are motivated for reasons you won’t like.</p>

<p>The fraudsters didn’t just steal money. They taxed everyone else’s candidate experience.</p>

<h3>Part Five: And now, the lawyers</h3>

<p>The thing I most underestimated last year was how fast “we should probably audit this” would become “you will be audited.”</p>

<p><a href="https://www.shrm.org/topics-tools/news/technology/workday-ai-lawsuit-wake-up-call-hr">Mobley v. Workday</a> is no longer a case to watch. It’s a case to plan around. Judge Rita Lin’s June 22, 2026 ruling kept core discrimination claims alive across race, sex, age, and disability, built on the earlier holding that a vendor whose tool screens candidates on your behalf can be treated as your agent. Translation: the employer can’t say “that’s the vendor’s problem,” and the vendor can’t say “we only make the software.”</p>

<p>But the ruling I’d actually put on the wall is the quieter one. In May 2026, a magistrate judge denied plaintiffs’ motion to compel Workday’s bias-testing data — because Workday’s attorneys had curated it and used it to provide legal advice, making it attorney-client privileged.</p>

<p>Read that again as a buyer. It is entirely possible for a vendor to run bias testing, structure it so the results are legally shielded, and still tell you in the sales cycle that they test for bias. Both statements are true. Only one of them helps you in a courtroom. “We do bias audits” is now a marketing claim, not a compliance artifact. Ask what you’d actually receive, in writing, if you were sued.</p>

<p>And the compliance floor moved under everyone’s feet in January:</p>

<ul>
  <li><strong>Illinois HB 3773</strong> (effective Jan 1, 2026) makes discriminatory effect from AI a civil rights violation, requires you to notify applicants when AI is used in employment decisions, bans zip codes as protected-class proxies — and carries a private right of action.</li>
  <li><strong>California’s FEHA regulations</strong> (effective Oct 2025) make bias testing, or its absence, explicitly relevant evidence, and require four years of retention on inputs, outputs, scores, and criteria.</li>
  <li><strong>NYC Local Law 144</strong> still requires independent bias audits, as it has since 2023.</li>
  <li><strong>Texas TRAIGA</strong> took effect Jan 1, 2026.</li>
  <li><strong>Colorado</strong> repealed its landmark AI Act and replaced it with a narrower regime pushed to January 2027 — the one genuine retreat, and the exception that proves how contested this is.</li>
</ul>

<p>The pattern across every one of these: liability sits with the deployer. The entity that pressed “go.” You cannot outsource it to a vendor, and the vendor’s indemnification language is worth exactly as much as its balance sheet.</p>

<h3>So what do you actually do</h3>

<p>Last year’s advice — be transparent, keep humans in the loop, audit your process — was correct but insufficient. It assumed good faith all around. Here’s the version that accounts for the world we’re actually in.</p>

<ol>
  <li><strong>Stop optimizing throughput. Start optimizing signal.</strong> 291 applications per hire isn’t a capacity problem you solve with a bigger filter. Watch completion rates, not application counts. Completion rate is itself a fraud signal, and the depth of the interview is what separates real skill from a polished claim. Anything that raises cost-to-apply for bad actors while lowering friction for real ones is worth more than another parser.</li>
  <li><strong>Disclose AI use before the candidate encounters it, not after.</strong> This is now legally required in Illinois and defensible everywhere else. Greenhouse’s finding was that most candidates weren’t told until they were already in the process. That’s the transparency failure — not the AI itself. Candidates aren’t rejecting the technology. They’re rejecting being surprised by it.</li>
  <li><strong>Separate verification from evaluation.</strong> Identity fraud and candidate quality are different problems. Blending them turns every applicant into a suspect and makes your process feel like a customs line. Verify identity cleanly and early. Evaluate skill separately, and let it feel human.</li>
  <li><strong>Rewrite what “qualified” means — again.</strong> Still the highest-leverage fix, still the one nobody does. If your criteria encode a career gap as a negative signal, you have built an age and disability proxy, and Illinois now calls that a civil rights violation regardless of intent.</li>
  <li><strong>Make peace with candidate AI, and draw one clear line.</strong> Say it out loud in the posting: AI-assisted preparation is fine. Live assistance during an evaluation is not. Then design assessments where the distinction actually matters. Punishing preparation while failing to catch deepfakes is the worst of both.</li>
  <li><strong>Change your vendor diligence questions.</strong> Not “do you audit for bias” — everyone says yes. Ask: Will you produce the audit results to me, contractually, on request? Are they privileged? Who’s the independent auditor? What’s your retention schedule for inputs, outputs, and scores, and can I get four years of it out of your system if I’m sued? What’s your indemnification, and what’s your cash position? That last one isn’t a joke — an indemnity from a vendor two quarters from a distressed sale is decorative.</li>
</ol>

<p>A year ago I closed by saying trust is the grease that keeps a high-volume hiring machine from seizing up. That still holds. But I’d add something I didn’t see clearly then.</p>

<p>The trust paradox was never really about AI. AI just removed the friction that used to hide how little trust was in the system to begin with. We were always screening out qualified people; the algorithm just did it faster and left a log. We were always posting jobs we weren’t filling; automation just made it cheap enough to do at scale. We always wanted candidates polished but not too polished; the tools just made the double standard impossible to ignore.</p>

<p>The machines didn’t break trust in hiring. They audited it.</p>

<hr />

<p>On to a quiet week in HR Tech news. This week’s Wrap features HR Executive’s Top HR Products announcement, G-P spinning up an MCP server, meeting notetakers under fire, a look at the UK job market for grads (it’s not good), how an executive search firm operates in the AI era, and Bill Gates raising alarms about our dystopian future. Enjoy and have a great weekend!</p>
...
<h3>HR Executive Top HR Products Announced</h3>
<img src="/newsletters/edition-86/top-hr-products-badge.webp" alt="The HR Executive Top HR Products award badge, a red and black circular seal" />
<p>Madeline Laurano, founder and chief analyst at Aptitude Research and a judge on this year’s HR Executive Top HR Products panel, wrote up what the evaluation process revealed and found this interesting tidbit during the judging process. While 74% of companies now use AI in HR and 69% use it in talent acquisition, only 12% report using agentic AI, while nearly every product submitted to the awards described itself as agentic. Laurano, who has attended HR Tech for 20 years, called this the hardest evaluation she’s been part of, partly because agentic systems are genuinely hard to demo in the now-standard 30-minute window.</p>
<p>Note to vendors: the demos that worked shared three traits — they opened with the problem and a baseline metric, they showed an action executed inside a real system rather than an answer generated in a chat window, and they showed the audit trail behind that action. The ones that didn’t spent their time on dashboards and PowerPoint.</p>
<p><a href="https://hrexecutive.com/2026-top-hr-products-recap-what-years-judging-revealed-about-where-market-going/">Read more</a>.</p>

<h3>G-P Ships an MCP Server</h3>
<img src="/newsletters/edition-86/gp-mcp-server.webp" alt="The G-P logo on a glowing yellow lightbulb rising above a crowd of illustrated people" />
<p>G-P (Globalization Partners) announced its Model Context Protocol server on August 26, letting customers stream real-time global employment data directly into Claude, ChatGPT, Gemini, Cursor, and core HR systems including Workday, ADP, Paylocity, and SAP. G-P chief product officer GK Konduri framed it as bringing the company’s compliance intelligence into the AI environments teams already use.</p>
<p>The governance layer is the part buyers should read: human-in-the-loop guardrails that re-route high-risk agentic actions for explicit approval, payload-level access limits tied to what the user is authorized to see, and redaction capability. G-P is not first here — Visier shipped MCP alongside its agentic platform earlier this year — but watch for more and more vendors to do this as AI use streamlines.</p>
<p><a href="https://www.prnewswire.com/news-releases/g-p-delivers-compliant-global-workforce-intelligence-to-enterprise-ai-tools-302859999.html">Read more</a>.</p>

<h3>Automatic Meeting Notetakers May Be Illegal</h3>
<img src="/newsletters/edition-86/otter-ai-privacy-ruling.webp" alt="The Otter.ai logo beside a bronze Lady Justice statue and a gavel on a courtroom desk" />
<p>On August 13, Judge Eumi K. Lee of the Northern District of California granted Otter.ai’s motion to dismiss in part and denied it in part in In re Otter.AI Privacy Litigation (No. 5:25-cv-06911-EKL), a consolidation of four proposed class actions filed between August and September 2025. Claims under the federal Wiretap Act, the California Invasion of Privacy Act, and Illinois’ Biometric Information Privacy Act survived; counts under the Computer Fraud and Abuse Act, California’s CDAFA, and the Washington Privacy Act were dismissed, most with leave to amend.</p>
<p>Otter had argued it was not a third-party interceptor but a tool operating at the direction of the meeting host, and the court found the complaint plausibly alleges Otter retained and used conversation data for its own commercial purposes, including training its machine-learning models. I’ll keep an eye on this as it has a trickle-down effect for lots of HR Tech.</p>
<p><a href="https://www.uctoday.com/productivity-automation/otter-ai-fails-to-dismiss-core-privacy-claims-in-u-s-court/">Read more</a>.</p>

<hr />

<h2>📉 Labor Market</h2>

<h3>UK Graduate Vacancies Hit a Decade Low</h3>
<img src="/newsletters/edition-86/uk-graduate-vacancies.webp" alt="A graduate in cap and gown walking past LSE recruitment posters outside a university building" />
<p>Things are not better across the pond. Adzuna reported 8,383 graduate vacancies advertised across the UK in July, down from 15,397 a year earlier — a 45.6% annual decline and the lowest figure since the company began tracking the category in 2016. For scale, more than 55,000 graduate positions were advertised in 2017. Total UK vacancies fell to 791,490 in July, the first monthly decline in five months, widening the annual drop to -9.6%; jobseekers per vacancy rose to 2.14 from 1.93 a year ago.</p>
<p><a href="https://www.theguardian.com/business/2026/aug/24/uk-graduate-job-vacancies-plunge-adzuna">Read more</a>.</p>

<hr />

<h2>🎙️ Podcasts</h2>

<h3>Executive Search in the AI Era</h3>
<img src="/newsletters/edition-86/executive-search-ai-era.webp" alt="Totally Talent podcast cover featuring Melissa Barker beside the episode title Executive Search in the AI Era" />
<p>What happens when AI meets the human side of executive hiring? Melissa Barker, Chief Revenue Officer at Duffy Group, takes us inside executive search — how AI is transforming recruiting, where the technology adds value, and why human judgment remains essential to making the right hiring decision.</p>
<p><a href="https://web.hr.com/rk3d">Listen to the episode</a>.</p>

<hr />

<h2>👆 Worth a Click</h2>

<h3>The Woman Guiding Tourists Through New York City’s Worst Day</h3>
<img src="/newsletters/edition-86/nyc-911-tour-guide.webp" alt="Tour guide Christina Stanton speaking to visitors beside the 9/11 Memorial reflecting pool, holding a framed photograph" />
<p>The New York Times profiles Christina Stanton, a licensed New York tour guide since 1995 who was living six blocks from the World Trade Center on September 11, 2001, and who now leads an hour-long tour of the site built around her own account of that morning. She and her husband escaped their 24th-floor apartment on foot — she in pajamas and socks, no shoes — and were lifted over a sea wall onto a ferry to New Jersey as part of the waterborne evacuation later dubbed the American Dunkirk.</p>
<p>I think it’s incredibly important as time progresses to remember what happened that day directly from the people that lived it. If you are a younger reader to this newsletter, check out <a href="https://www.911memorial.org/learn/resources/oral-histories">the oral histories on the 9/11 Museum website</a>.</p>
<p><a href="https://www.nytimes.com/2026/08/24/nyregion/the-woman-guiding-tourists-through-new-york-citys-worst-day.html">Read more</a>.</p>

<h3>Bill Gates Weighs In On The Dangers of AI</h3>
<img src="/newsletters/edition-86/bill-gates-turbulent-ai.webp" alt="The Gates Notes essay header: An Epochal Shift — The turbulent AI era is here. The choices we make now are critical." />
<p>Bill Gates published a roughly 6,000-word essay on Gates Notes on August 26 arguing that the AI transition will rank among the most disruptive periods in human history and that leaders, experts, and communities are not confronting it adequately. His framing of the job-loss risk is the part with the most direct HR relevance: he argues that comparisons to the agricultural-to-office shift understate what’s coming, because AI substitutes directly for human cognition across law, medicine, customer service, software, and manufacturing, and will do so over a decade rather than across generations.</p>
<p>He offers three proposals — new national and international institutions modeled on nuclear inspections and aviation rules, a tax on AI tokens and robots to offset a tax code that lets companies deduct a robot while paying payroll taxes on a worker, and a category he calls “Human Reserved”: work machines could fully do that we decide to keep for people anyway, on the model of a nature reserve. His example is a robot delivering an incurable-disease diagnosis, which he says there is no technical reason it couldn’t do, and shouldn’t. Worth a read if you have the time.</p>
<p><a href="https://www.gatesnotes.com/a-turbulent-ai-era-and-critical-choices-to-make">Read more</a>.</p>
`,
  },
  {
