...
const rawVendors = [
  // HCM
  { name: 'Workday',              slug: 'workday',              category: 'HCM',       g2: 4.1, capterra: 4.4, reviews: 2800,  employees: '18,000+',  news: 12, deepDive: false, website: 'workday.com',                       description: 'Enterprise-grade HCM suite covering HR, finance, and planning in a single cloud platform.' },
  { name: 'SAP SuccessFactors',   slug: 'sap-successfactors',   category: 'HCM',       g2: 3.9, capterra: 4.0, reviews: 1000,  employees: '100,000+', news: 16, deepDive: false, website: 'successfactors.com',                 description: 'Cloud-based HCM suite from SAP for global enterprise workforce management.' },
  ...
  { name: 'UKG Pro',              slug: 'ukg-pro',              category: 'HCM',       g2: 4.3, capterra: 4.3, reviews: 2100,  employees: '15,000+',  news: 10, deepDive: false, website: 'ukg.com',                            description: 'Comprehensive HCM platform built from the merger of Ultimate Software and Kronos.' },
  ...
  // ATS
  { name: 'Greenhouse',           slug: 'greenhouse',           category: 'ATS',       g2: 4.4, capterra: 4.5, reviews: 2800,  employees: '800+',     news: 9,  deepDive: false, website: 'greenhouse.com',                     description: 'Structured hiring platform built for data-driven recruiting teams.' },
  ...
  { name: 'iCIMS',                slug: 'icims',                category: 'ATS',       g2: 4.1, capterra: 4.3, reviews: 1600,  employees: '1,800+',   news: 7,  deepDive: false, website: 'icims.com',                          description: 'Enterprise recruiting platform with a broad ecosystem of integrations and assessments.' },
  ...
  { name: 'Gusto',                slug: 'gusto',                category: 'HRIS',      g2: 4.5, capterra: 4.6, reviews: 6100,  employees: '2,500+',   news: 13, deepDive: false, website: 'gusto.com',                          description: 'Payroll, benefits, and HR platform built for SMBs and their teams.' },
  ...
  { name: 'Paylocity',            slug: 'paylocity',            category: 'Payroll',   g2: 4.4, capterra: 4.3, reviews: 3600,  employees: '6,000+',   news: 7,  deepDive: false, website: 'paylocity.com',                      description: 'Cloud-based payroll and HCM with a focus on employee communication and engagement.' },
  ...
  { name: 'Docebo',               slug: 'docebo',               category: 'L&D',       g2: 4.4, capterra: 4.3, reviews: 700,   employees: '700+',     news: 5,  deepDive: false, website: 'docebo.com',                         description: 'AI-powered LMS for enterprise-scale learning and customer education programs.' },
...
export const activityFeed = [
  ...
  { headline: 'SAP SuccessFactors 1H 2026 preview brings agentic AI suite-wide and EU pay transparency tools', source: 'SAP News Center', date: 'Apr 13', vendor: 'SAP SuccessFactors' },
  { headline: 'Docebo April release ships AI learning sidepanel and MCP integration for in-workflow training access', source: 'Docebo', date: 'Apr 2026', vendor: 'Docebo' },
  { headline: 'Gusto acquires Mosey to bring AI-powered compliance management in-platform', source: 'PR Newswire', date: 'Apr 9', vendor: 'Gusto' },
  { headline: 'Paylocity acquires Grayscale to expand AI-powered recruiting capabilities', source: 'Globe Newswire', date: 'Apr 7', vendor: 'Paylocity' },
  { headline: 'Remote acquires Bravas to add identity and device management to global EOR platform', source: 'PR Newswire', date: 'Apr 9', vendor: 'Remote' },
  { headline: 'SmartRecruiters introduces AI agents for autonomous end-to-end talent acquisition', source: 'Globe Newswire', date: 'Apr 7', vendor: 'SmartRecruiters' },
  { headline: 'Papaya Global and Tech Mahindra announce global workforce operations alliance', source: 'PR Newswire', date: 'Apr 12', vendor: 'Papaya Global' },
  ...
  { headline: 'iCIMS unveils Copilot AI recruiting assistant at HR Tech conference', source: 'iCIMS Newsroom', date: 'Apr 6', vendor: 'iCIMS' },
  { headline: 'Greenhouse ranked #1 ATS in G2 Spring 2026 Reports across Enterprise and Mid-Market', source: 'PR Newswire', date: 'Apr 4', vendor: 'Greenhouse' },
  ...
  { headline: 'Darwinbox raises $40M from Ontario Teachers to accelerate North America push', source: 'Outlook Business', date: 'Apr 1', vendor: 'Darwinbox' },
  { headline: 'Degreed named Strategic Leader in 2026 Fosway 9-Grid for Learning Systems', source: 'Business Wire', date: 'Apr 8', vendor: 'Degreed' },
]
