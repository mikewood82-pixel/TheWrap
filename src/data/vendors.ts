...
const rawVendors = [
  // HCM
  { name: 'Workday',              slug: 'workday',              category: 'HCM',       g2: 4.1, capterra: 4.4, reviews: 2800,  employees: '18,000+',  news: 17, deepDive: false, website: 'workday.com',                       description: 'Enterprise-grade HCM suite covering HR, finance, and planning in a single cloud platform.' },
  ...
  { name: 'Darwinbox',            slug: 'darwinbox',            category: 'HCM',       g2: 4.4, capterra: 4.4, reviews: 150,   employees: '1,000+',   news: 5,  deepDive: false, website: 'darwinbox.com',                      description: 'Mobile-first HCM platform built for high-growth companies in Asia and globally.' },
