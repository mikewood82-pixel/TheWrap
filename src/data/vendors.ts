...
const rawVendors = [
  // HCM
  { name: 'Workday',              slug: 'workday',              category: 'HCM',       g2: 4.0, capterra: 4.4, reviews: 2800,  employees: '18,000+',  news: 12, deepDive: false, website: 'workday.com',                       description: 'Enterprise-grade HCM suite covering HR, finance, and planning in a single cloud platform.' },
  { name: 'SAP SuccessFactors',   slug: 'sap-successfactors',   category: 'HCM',       g2: 3.9, capterra: 4.0, reviews: 1000,  employees: '100,000+', news: 15, deepDive: false, website: 'successfactors.com',                 description: 'Cloud-based HCM suite from SAP for global enterprise workforce management.' },
  { name: 'Oracle HCM Cloud',     slug: 'oracle-hcm-cloud',     category: 'HCM',       g2: 3.7, capterra: 4.0, reviews: 700,   employees: '150,000+', news: 11, deepDive: false, website: 'oracle.com',                         description: "Oracle's global HR platform integrating talent, payroll, and workforce management." },
  { name: 'UKG Pro',              slug: 'ukg-pro',              category: 'HCM',       g2: 4.2, capterra: 4.3, reviews: 2100,  employees: '15,000+',  news: 9,  deepDive: false, website: 'ukg.com',                            description: 'Comprehensive HCM platform built from the merger of Ultimate Software and Kronos.' },
  ...
  { name: 'Darwinbox',            slug: 'darwinbox',            category: 'HCM',       g2: 4.3, capterra: 4.4, reviews: 150,   employees: '1,000+',   news: 3,  deepDive: false, website: 'darwinbox.com',                      description: 'Mobile-first HCM platform built for high-growth companies in Asia and globally.' },
  ...
  // ATS
  { name: 'Greenhouse',           slug: 'greenhouse',           category: 'ATS',       g2: 4.4, capterra: 4.5, reviews: 2800,  employees: '800+',     news: 8,  deepDive: false, website: 'greenhouse.com',                     description: 'Structured hiring platform built for data-driven recruiting teams.' },
  ...
  { name: 'iCIMS',                slug: 'icims',                category: 'ATS',       g2: 4.1, capterra: 4.3, reviews: 1600,  employees: '1,800+',   news: 6,  deepDive: false, website: 'icims.com',                          description: 'Enterprise recruiting platform with a broad ecosystem of integrations and assessments.' },
  ...
  { name: 'SmartRecruiters',      slug: 'smartrecruiters',      category: 'ATS',       g2: 4.2, capterra: 4.2, reviews: 900,   employees: '700+',     news: 5,  deepDive: false, website: 'smartrecruiters.com',                description: 'Enterprise TA suite with a built-in marketplace of recruiting apps and assessments.' },
  ...
  // HRIS
  { name: 'BambooHR',             slug: 'bamboohr',             category: 'HRIS',      g2: 4.4, capterra: 4.6, reviews: 5200,  employees: '1,200+',   news: 7,  deepDive: false, website: 'bamboohr.com',                       description: 'HR software for small and mid-sized companies with a well-earned reputation for great UX.' },
  { name: 'Rippling',             slug: 'rippling',             category: 'HRIS',      g2: 4.8, capterra: 4.9, reviews: 8000,  employees: '3,000+',   news: 24, deepDive: false, website: 'rippling.com',                       description: 'Unified workforce platform connecting HR, IT, and finance in one system.' },
  { name: 'Gusto',                slug: 'gusto',                category: 'HRIS',      g2: 4.5, capterra: 4.6, reviews: 6100,  employees: '2,500+',   news: 11, deepDive: false, website: 'gusto.com',                          description: 'Payroll, benefits, and HR platform built for SMBs and their teams.' },
  ...
  { name: 'Personio',             slug: 'personio',             category: 'HRIS',      g2: 4.3, capterra: 4.6, reviews: 900,   employees: '2,000+',   news: 6,  deepDive: false, website: 'personio.com',                       description: 'European all-in-one HR platform for small and mid-sized companies.' },
  { name: 'HiBob',                slug: 'hibob',                category: 'HRIS',      g2: 4.5, capterra: 4.6, reviews: 1200,  employees: '1,000+',   news: 7,  deepDive: false, website: 'hibob.com',                          description: "Modern HRIS (called Bob) designed for today's global, distributed workforce." },
  ...
  { name: 'Paylocity',            slug: 'paylocity',            category: 'Payroll',   g2: 4.4, capterra: 4.3, reviews: 3600,  employees: '6,000+',   news: 6,  deepDive: false, website: 'paylocity.com',                      description: 'Cloud-based payroll and HCM with a focus on employee communication and engagement.' },
  ...
  { name: 'Remote',               slug: 'remote',               category: 'Payroll',   g2: 4.6, capterra: 4.8, reviews: 1600,  employees: '1,000+',   news: 8,  deepDive: false, website: 'remote.com',                         description: 'Global payroll, benefits, and compliance platform for distributed teams.' },
  { name: 'Papaya Global',        slug: 'papaya-global',        category: 'Payroll',   g2: 4.3, capterra: 4.4, reviews: 300,   employees: '700+',     news: 4,  deepDive: false, website: 'papayaglobal.com',                   description: 'Automated global payroll and workforce management platform for multinational companies.' },
  ...
  // Perf Mgmt
  { name: 'Lattice',              slug: 'lattice',              category: 'Perf Mgmt', g2: 4.7, capterra: 4.5, reviews: 4000,  employees: '600+',     news: 5,  deepDive: false, website: 'lattice.com',                        description: 'Performance management and engagement platform with OKR and people analytics features.' },
  ...
  // L&D
  { name: 'Cornerstone OnDemand', slug: 'cornerstone-ondemand', category: 'L&D',       g2: 4.1, capterra: 4.1, reviews: 1000,  employees: '3,000+',   news: 5,  deepDive: false, website: 'cornerstoneondemand.com',            description: 'Enterprise learning and talent management suite with deep compliance and skills features.' },
  { name: 'Docebo',               slug: 'docebo',               category: 'L&D',       g2: 4.4, capterra: 4.3, reviews: 700,   employees: '700+',     news: 4,  deepDive: false, website: 'docebo.com',                         description: 'AI-powered LMS for enterprise-scale learning and customer education programs.' },
  ...
  { name: 'Degreed',              slug: 'degreed',              category: 'L&D',       g2: 4.3, capterra: 4.2, reviews: 500,   employees: '600+',     news: 3,  deepDive: false, website: 'degreed.com',                        description: 'Learning experience platform for continuous skill-building and career development.' },
  ...
  // Analytics
  { name: 'Visier',               slug: 'visier',               category: 'Analytics', g2: 4.4, capterra: 4.3, reviews: 300,   employees: '700+',     news: 5,  deepDive: false, website: 'visier.com',                         description: 'Purpose-built people analytics platform used by global enterprises for workforce insights.' },
  ...
  { name: 'Medallia',             slug: 'medallia',             category: 'Analytics', g2: 4.3, capterra: 4.3, reviews: 400,   employees: '2,000+',   news: 5,  deepDive: false, website: 'medallia.com',                       description: 'Customer and employee experience platform with advanced text and signal analytics.' },
...
const glassdoorRatings: Record<string, number> = {
  'workday': 4.0, 'sap-successfactors': 3.8, 'oracle-hcm-cloud': 3.5, 'ukg-pro': 3.8,
  ...
  'bamboohr': 4.2, 'rippling': 4.2, 'gusto': 4.1, 'zenefits': 3.5, 'personio': 4.1,
...
export const activityFeed = [
  { headline: 'Paylocity: A Prime GARP Candidate as Payroll Consolidation Continues', source: 'ChartMill', date: 'Apr 6', vendor: 'Paylocity' },
  { headline: 'Paychex CFO sells $4.2M in shares; analyst maintains Outperform rating', source: 'Seeking Alpha', date: 'Apr 5', vendor: 'Paychex' },
  { headline: 'Workday names new CEO as co-founder Carl Eschenbach steps down', source: 'TechCrunch', date: 'Apr 4', vendor: 'Workday' },
  { headline: 'Rippling launches Workforce Benchmarking — free tool for HR leaders', source: 'BusinessWire', date: 'Apr 4', vendor: 'Rippling' },
  { headline: 'Lattice acquires Mandala to expand people analytics capabilities', source: 'HR Dive', date: 'Apr 3', vendor: 'Lattice' },
  { headline: 'HiBob launches Global Chapters for distributed team community building', source: 'Globe Newswire', date: 'Apr 3', vendor: 'HiBob' },
  { headline: 'ADP beats Q2 estimates; raises FY guidance on payroll volume strength', source: 'Reuters', date: 'Apr 2', vendor: 'ADP' },
  { headline: 'Culture Amp releases State of the Manager report: 62% lack confidence in feedback skills', source: 'Culture Amp Blog', date: 'Apr 2', vendor: 'Culture Amp' },
  { headline: 'Deel crosses $500M ARR milestone, eyes public markets in 2025', source: 'Bloomberg', date: 'Apr 1', vendor: 'Deel' },
  { headline: 'UKG Pro adds AI-powered shift recommendations for healthcare clients', source: 'PR Newswire', date: 'Mar 31', vendor: 'UKG Pro' },
  { headline: 'Greenhouse integrates with LinkedIn Recruiter for real-time candidate sync', source: 'Greenhouse Blog', date: 'Mar 30', vendor: 'Greenhouse' },
  { headline: 'Visier raises $125M Series F to accelerate enterprise people analytics expansion', source: 'VentureBeat', date: 'Mar 29', vendor: 'Visier' },
  { headline: 'Gusto launches HR features for multi-state employers amid compliance demand', source: 'Forbes', date: 'Mar 28', vendor: 'Gusto' },
  { headline: 'BambooHR tops G2 SMB HRIS rankings for fifth consecutive quarter', source: 'G2', date: 'Mar 28', vendor: 'BambooHR' },
  { headline: 'SAP SuccessFactors embeds Joule AI assistant across all HCM modules', source: 'SAP News', date: 'Mar 27', vendor: 'SAP SuccessFactors' },
]
